...
namespace saor.GUI.Apps
{
    public class Desktop : Window
    {
        ...
        public override void Render()
        {
            try
            {
                for (int y = 0; y < WindowManager.Screen.Height; y += Resources.Background.Height)
                    for (int x = 0; x < WindowManager.Screen.Width; x += Resources.Background.Width)
